package ru.rubcov.gateway.controller;
...
import ru.rubcov.gateway.controller.exception.data.RequestDataErrorException;
import ru.rubcov.gateway.dto.*;
import ru.rubcov.gateway.service.GatewayService;
